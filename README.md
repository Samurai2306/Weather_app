...
Приложение показывает текущую погоду, прогноз на 3 дня, а также детальную информацию для специальных локаций: станции Мытищи, Ярославского вокзала в Москве, корпусов РТУ МИРЭА и МЭИ, а также локации "Дача". Для маршрутов до университетов доступен прогноз погоды с временными интервалами.

### Основные возможности

- **Погода по городам** — выбор из 18 городов России (Москва, Санкт-Петербург, Сочи, города Московской области)
